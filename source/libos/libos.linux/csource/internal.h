...
uintptr_t syscall(uintptr_t num, uintptr_t a, uintptr_t b, uintptr_t c,
...
#define SYSCALL_PROC1(name, t0, r0)     \
    ...
    {\
        uintptr_t ret = syscall(SYSCALL_##name, (uintptr_t)r0, 0, 0, 0, 0); \
        \
...
#define SYSCALL_FUNC3(name, rettype, t0, r0,t1,  r1, t2, r2) \
    ...
    {\
        uintptr_t ret = syscall(SYSCALL_##name, (uintptr_t)r0, (uintptr_t)r1, (uintptr_t)r2, 0, 0);\
        \
        ret = func(check_syscall(ret)); \
        \
        return ret;\
