...
#    define cell_utf8_max            6 /* maximum bytes per character */
#    define cell_utf8_single         0x80
#    define cell_utf8_error          ((cell_char)-1)

// func isalpha(c char) bool
cell_bool cell_utf8_isalpha(cell_char c);

// func iscntrl(c char) bool
cell_bool cell_utf8_iscntrl(cell_char c);

// func isdigit(c char) bool
cell_bool cell_utf8_isdigit(cell_char c);

// func toint(c char) int
cell_int8 cell_utf8_toint(cell_char c);

// func islower(c char) bool
cell_bool cell_utf8_islower(cell_char c);

// func isspace(c char) bool
cell_bool cell_utf8_isspace(cell_char c);

// func istitle(c char) bool
cell_bool cell_utf8_istitle(cell_char c);

// func isupper(c char) bool
cell_bool cell_utf8_isupper(cell_char c);

// func tolower(c char) char
cell_char cell_utf8_tolower(cell_char c);

// func toupper(c char) char
cell_char cell_utf8_toupper(cell_char c);
